...
class WyhashFinal3Test extends AbstractHasher64Test {
  ...
  protected void calculateHashForChecksum(
    ...
    long hash0 = Hashing.wyhashFinal3().hashBytesToLong(o, off, len, byteAccess);
    long hash1 = Hashing.wyhashFinal3(seed0).hashBytesToLong(o, off, len, byteAccess);
    long hash2 = 0;
    long hash3 = 0;
    if ((rand & 0x3fL) == 0) {
      hash2 = Hashing.wyhashFinal3(0L, seed1).hashBytesToLong(o, off, len, byteAccess);
      hash3 = Hashing.wyhashFinal3(seed0, seed1).hashBytesToLong(o, off, len, byteAccess);
    }
