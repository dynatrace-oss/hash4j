...
public abstract class AbstractJpountz32BitPerformanceTest extends AbstractPerformanceTest {

  @Override
  protected void hashBytesDirect(byte[] b, Blackhole blackhole) {
    blackhole.consume(createHashFunction().hash(b, 0, b.length, 0));
  }
  ...
  protected abstract XXHash32 createHashFunction();
}
