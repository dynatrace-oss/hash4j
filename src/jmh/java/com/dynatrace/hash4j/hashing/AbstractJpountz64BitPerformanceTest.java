...
public abstract class AbstractJpountz64BitPerformanceTest extends AbstractPerformanceTest {

  @Override
  protected void hashBytesDirect(byte[] b, Blackhole blackhole) {
    blackhole.consume(createHashFunction().hash(b, 0, b.length, 0L));
  }
  ...
  protected abstract XXHash64 createHashFunction();
}
