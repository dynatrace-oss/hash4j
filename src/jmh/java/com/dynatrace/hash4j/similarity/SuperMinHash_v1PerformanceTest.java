...
public class SuperMinHash_v1PerformanceTest extends SimilarityHashingPerformanceTest {

  public static class State_64_1 extends StateBase {
    public State_64_1() {
      super(new SuperMinHashPolicy_v1(64, 1, getPseudoRandomGeneratorProvider()).createHasher());
    }
  }

  public static class State_256_1 extends StateBase {
    public State_256_1() {
      super(new SuperMinHashPolicy_v1(256, 1, getPseudoRandomGeneratorProvider()).createHasher());
    }
  }

  public static class State_1024_1 extends StateBase {
    public State_1024_1() {
      super(new SuperMinHashPolicy_v1(1024, 1, getPseudoRandomGeneratorProvider()).createHasher());
    }
  }

  public static class State_4096_1 extends StateBase {
    public State_4096_1() {
      super(new SuperMinHashPolicy_v1(4096, 1, getPseudoRandomGeneratorProvider()).createHasher());
    }
  }
