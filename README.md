...
The theoretically predicted estimation errors  have been empirically confirmed by [simulation results](../main/doc/hyperloglog-estimation-error.md).
...
$\frac{0.658}{\sqrt{m}}$. These theoretical formulas again agree well with the [simulation results](../main/doc/ultraloglog-estimation-error.md).
